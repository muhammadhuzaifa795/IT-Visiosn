  ...
  return (
    <div className="font-roboto">
      ...
      <button
        ...
        className="flex items-center gap-3 p-4 w-full hover:bg-gray-100/50 transition-colors border-t border-gray-300"
      >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border-gray-300 border rounded-md p-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div className="flex items-start gap-3">
              ...
              <textarea
                ...
                className="flex-1 bg-transparent border-b border-gray-300 placeholder-gray-500 focus:outline-none focus:border-blue-500 py-2 resize-none text-sm"
            ...
            <div className="flex justify-end gap-2">
              <button
                type="button"
                onClick={() => setText("")}
                className="text-gray-600 hover:text-gray-800 text-sm px-4 py-1"
              >
                Cancel
              </button>
              <button
              ...
              <>
                ...
                {hasMoreComments && (
                  <button
                    ...
                    className="w-full py-3 text-blue-500 hover:text-blue-600 hover:bg-gray-100/50 rounded-lg transition-colors text-sm font-medium"
                  >
